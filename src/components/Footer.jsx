            ...
            <div className="container">
                <div className="footer__inner">
                    ...
                    <div className="footer__social">
                        ...
                        <a href="https://www.instagram.com/pedotti.marketing/" target="_blank" rel="noopener noreferrer" className="footer__social-link" aria-label="Instagram">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="footer__bottom">
                    <span className="footer__copyright">© {year} Pedotti. Todos os direitos reservados.</span>
                    <span className="footer__tagline">IA personalizada para operações que exigem excelência.</span>
                </div>
            </div>
        </footer>
    );
