...
const Globe = ({
    dotColor = 'rgba(30, 30, 30, ALPHA)',
    arcColor = 'rgba(30, 30, 30, 0.25)',
    markerColor = 'rgba(10, 10, 10, 1)',
    ...
    const draw = useCallback(() => {
        ...
        for (const marker of markers) {
            ...
            if (marker.label) {
                ...
                ctx.fillStyle = markerColor.replace('1)', '0.45)');
                ctx.fillText(marker.label, sx + 6, sy + 3);
            }
        }
